...
public abstract class P2AutoCommand extends SequentialCommand {
    ...
    // Start 26.3 inches from the tape, and 33.125 inches from the bottom of the charging station
    private final Pose2d startingPos = new Pose2d(new Translation2d(1.042703, 2.746756 * yMult), new Rotation2d(180));
